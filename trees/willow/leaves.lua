default.register_fence("basic_trees:fence_willow", {
	...
	material = "basic_trees:willow_planks",
...
minetest.register_node("basic_trees:willow_leaves", {
  description = "Willow Leaves",
  drawtype = "allfaces_optional",
  waving = 1,

  tiles = { "willow_leaves.png" },
  special_tiles = {"willow_leaves.png"},
  paramtype = "light",
  ...
  drop = {
    max_items = 1,
    items = {
      {items = {"basic_trees:willow_sapling"}, rarity = 115 },
      {items = {"basic_trees:willow_leaves"} }
    }
  },
})

minetest.register_node("basic_trees:willow_trunk", {
...
minetest.register_node("basic_trees:willow_planks", {
...
minetest.register_node("basic_trees:willow_sapling", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		willow_growth(pos,1,2)
	end,

	on_construct = function(pos)
		if willow_growth(pos,1,1) then
...
default.register_leafdecay({
	trunks = {"basic_trees:willow_trunk"},
	leaves = {"basic_trees:willow_leaves"},
	radius = 3,
})
